                ...
                <div className="flex-grow flex flex-wrap -mb-10 md:mt-0 mt-10 md:text-left text-center">
                    ...
                    <div className="lg:w-1/4 md:w-1/2 w-full px-4 min-w-[280px] sm:min-w-0">
                        ...
                        <div className="flex items-center justify-center md:justify-start mt-2 mb-1">
                            <a href={`tel:${t('footer.contacts.phone').replace(/[^\d+]/g, '')}`} className="hover:text-blue-600 hover:underline">
                                <span className="font-medium text-sm sm:text-base">{t('footer.contacts.phone')}</span>
                            </a>
                        </div>
