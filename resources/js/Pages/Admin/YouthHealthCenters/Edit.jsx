...
export default function YouthHealthCenterEdit({ center }) {
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        put(route('admin.youth-health-centers.update', center.id));
    };

    return (
        <>
            <Head title={`Редактирование МЦЗ: ${center.name}`} />
...
YouthHealthCenterEdit.layout = page => <AdminLayout title="Редактирование МЦЗ">{page}</AdminLayout>;
