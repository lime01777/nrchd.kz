...
export default function Create() {
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        post(route('admin.research-hub.store'));
    };

    // The identical handlers to Edit.jsx
    ...
    return (
        <AdminLayout title={`Добавление исследования`}>
            <div className="flex justify-between items-center mb-6">
                <h1 className="text-2xl font-semibold text-gray-900">Новое исследование</h1>
                <Link
            ...
            <div className="bg-white rounded-lg shadow overflow-hidden">
                ...
                <form onSubmit={handleSubmit} className="p-6">
                    ...
                    <div className="mt-8 pt-5 border-t border-gray-200 flex justify-end">
                        ...
                        >
                            {processing ? 'Создание...' : 'Создать исследование'}
                        </button>
                    </div>
                </form>
            </div>
