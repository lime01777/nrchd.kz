...
export default function VacancyCreate() {
    ...
    const [functionalResponsibilitiesText, setFunctionalResponsibilitiesText] = useState('');
    const [qualificationRequirementsText, setQualificationRequirementsText] = useState('');
    const [applicationProcedureText, setApplicationProcedureText] = useState('');
    ...
    const { data, setData, post, processing, errors } = useForm({
        ...
        department: '',
        employment_type: '',
        status: 'published', // Изменено с 'draft' на 'published' - вакансии по умолчанию публикуются
