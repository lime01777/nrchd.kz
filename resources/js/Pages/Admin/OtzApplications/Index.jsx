            ...
            <div className="p-6 bg-white border-b border-gray-200">
              ...
              <div className="flex justify-between items-center mb-6">
                ...
                <Link
                  ...
                  className="bg-fuchsia-500 hover:bg-fuchsia-600 text-white px-4 py-2 rounded-xl transition-colors"
                >
                  Создать заявку
                </Link>
              </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-5 gap-4">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-3 py-2 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-fuchsia-500"
                    />
                  </div>
                  <div>
                  ...
                  <div className="flex items-end space-x-2">
                    <button
                      ...
                      className="flex-1 px-4 py-2 bg-fuchsia-500 text-white rounded-xl hover:bg-fuchsia-600 transition-colors"
                    >
                      Применить
                    </button>
                    <button
                      onClick={clearFilters}
                      className="flex-1 px-4 py-2 bg-gray-50/500 text-white rounded-xl hover:bg-gray-600 transition-colors"
                    >
                      Сбросить
                    </button>
                  </div>
                  ...
                  <tbody className="bg-white divide-y divide-gray-200">
                    {applications.data.map((application) => (
                      <tr key={application.id} className="hover:bg-gray-50/50">
                        ...
                        <td className="px-6 py-4 whitespace-nowrap">
                          <span className={`px-2 py-1 text-xs font-medium rounded-full ${application.is_active
                  ...
                  <nav className="flex items-center space-x-2">
                    {applications.links.map((link, index) => (
                      <Link
                        key={index}
                        href={link.url}
                        className={`px-3 py-2 text-sm font-medium rounded-xl ${link.active
