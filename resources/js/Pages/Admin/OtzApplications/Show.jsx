              ...
              <div className="flex justify-between items-center mb-6">
                ...
                <div className="flex space-x-2">
                  <Link
                    ...
                    className="bg-indigo-500 hover:bg-indigo-600 text-white px-4 py-2 rounded-xl transition-colors"
                  >
                    Редактировать
                  </Link>
                  <Link
                    ...
                    <div className="bg-gray-50/50 p-4 rounded-2xl">
                      ...
                      <div className="space-y-4">
                        {Object.entries(application.stage_progress).map(([stage, progress]) => (
                          <div key={stage} className="border border-gray-200 rounded-2xl p-3">
