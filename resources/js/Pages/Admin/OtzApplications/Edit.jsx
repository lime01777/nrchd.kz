...
export default function Edit({ application, categories, stages, users }) {
  const { data, setData, put, processing, errors } = useForm({
    ...
    stage_start_date: application.stage_start_date || '',
    stage_end_date: application.stage_end_date || '',
    is_active: application.is_active !== undefined ? application.is_active : true,
  });
  ...
  return (
    <AdminLayout>
      <Head title="Редактирование заявки ОТЗ" />
          ...
          <div className="bg-white overflow-hidden shadow-sm sm:rounded-lg">
            <div className="p-6 bg-white border-b border-gray-200">
              ...
              <div className="flex justify-between items-center mb-6">
                <div>
                  <h2 className="text-2xl font-semibold text-gray-900">Редактирование заявки ОТЗ</h2>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <div>
                      ...
                      >
                        ...
                        {data.responsible_person && !users.find(u => u.name === data.responsible_person) && (
                          <option value={data.responsible_person}>{data.responsible_person}</option>
                        )}
                      </select>
