...
export default function TranslationCreate({ groups }) {
                    ...
                    <div className="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                        <div className="p-6">
                            <div className="flex justify-between items-center mb-6">
                                <h1 className="text-2xl font-semibold text-gray-900">Создание перевода</h1>
                                <Link
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    <div>
                                        ...
                                        <p className="text-sm text-gray-500 mt-1">
                                            Например: "home.title" или "about.description"
                                        </p>
                                    </div>
                                    ...
                                    <div>
                                        ...
                                        <p className="text-sm text-gray-500 mt-1">
                                            Обычно соответствует имени страницы или компонента
                                        </p>
                                    </div>
                                    ...
                                    <div className="md:col-span-2">
                                        ...
                                        <p className="text-sm text-gray-500 mt-1">
                                            Можно оставить пустым для последующего автоматического перевода
                                        </p>
                                    </div>
