    ...
    <section className="text-gray-600 body-font pb-8">
        <div className="container px-5 py-12 mx-auto">
          <div className='flex flex-wrap px-12 text-justify'>
            ...
            Кадровые ресурсы здравоохранения — не абстрактные единицы, а реальные врачи, медицинские сестры, фармацевты и другие работники системы здравоохранения. Чтобы все они, как одно целое, эффективно заботились о самом главном — здоровье населения, работает Обсерватория кадровых ресурсов здравоохранения.
