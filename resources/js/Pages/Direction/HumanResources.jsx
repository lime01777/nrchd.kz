    ...
    <section className="text-gray-600 body-font pb-8">
        <div className="container px-5 py-12 mx-auto">
          ...
          <div className="w-full overflow-hidden transition-all duration-500 ease-in-out mt-4">
            ...
            <h3 className="font-bold text-lg text-gray-800 mb-3">Формирование кадров</h3>
            <p className="mb-4 tracking-wide text-gray-700 leading-relaxed">
            ...
            <h3 className="font-bold text-lg text-gray-800 mb-3 mt-6">Деятельность экспертной команды в области управления медицинскими кадрами</h3>
            <p className="mb-4 tracking-wide text-gray-700 leading-relaxed">
            ...
            <h4 className="font-semibold text-gray-800 mb-2">1. Подготовка аналитических исследований.</h4>
            ...
            <ul className="list-disc pl-6 mb-3 space-y-1">
              <li>текущей потребностей в специалистах;</li>
              <li>демографического прогноза роста/снижения численности населения;</li>
              <li>специфики оказываемых медицинских услуг.</li>
            </ul>
            <p className="mb-4 tracking-wide text-gray-700 leading-relaxed">
            ...
            <h4 className="font-semibold text-gray-800 mb-2">2. Анализ дефицита и оттока медицинских кадров</h4>
            <p className="mb-2 tracking-wide text-gray-700 leading-relaxed">
              Команда изучает причины:
            </p>
            <ul className="list-disc pl-6 mb-3 space-y-1">
              <li>сокращения числа действующих медицинских работников;</li>
              <li>перехода специалистов в смежные отрасли или частный сектор;</li>
              <li>показатели текучести кадров в целом по отрасли, организациях ПМСП;</li>
              <li>исследует миграцию как внутреннюю, так и внешнюю медицинских кадров.</li>
            </ul>
            <p className="mb-4 tracking-wide text-gray-700 leading-relaxed">
              Результаты используются для принятия обоснованных политических решений, увеличения мер социальной поддержки.
            </p>
            
            <h4 className="font-semibold text-gray-800 mb-2">3. Планирование и прогнозирование необходимого количества медицинских кадров</h4>
            <p className="mb-2 tracking-wide text-gray-700 leading-relaxed">
              Планирование ведется на кратко- средне- и долгосрочную перспективу. Особое внимание уделяется:
            </p>
            <ul className="list-disc pl-6 mb-3 space-y-1">
              <li>учету числа работников предпенсионного и пенсионного возраста;</li>
              <li>динамике заболеваемости росту/снижению;</li>
              <li>оценке рисков массового выхода из профессии.</li>
            </ul>
            <p className="mb-4 tracking-wide text-gray-700 leading-relaxed">
            ...
            <h3 className="font-bold text-lg text-gray-800 mb-3">Основные направления работы Обсерватории</h3>
            <ul className="list-disc pl-6 mb-4 space-y-1">
              <li>Мониторинг кадровой обеспеченности, проводит аналитику о состоянии кадровых ресурсов в системе здравоохранения.</li>
              <li>Разработка подходов и методик по анализу количественного и качественного состава медицинских работников.</li>
              <li>Прогнозирование кадровых ресурсов здравоохранения.</li>
              <li>Разработка предложений по совершенствованию нормативно правой базы, регулирующей вопросы кадрового обеспечения.</li>
