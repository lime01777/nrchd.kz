...
StrategicInitiatives.layout = page => <LayoutDirection img="strategy" h1="Стратегические инициативы и межродовое сотрудничество" useVideo={true}>{page}</LayoutDirection>;
