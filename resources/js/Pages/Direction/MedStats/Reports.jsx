      ...
      <section className="text-gray-600 body-font pb-24">
        <div className="container px-5 mx-auto">
          ...
          <div className="bg-white rounded-lg shadow-md p-6 border border-gray-300">
            <SimpleFileDisplay 
              folder="Медицинская статистика/Отчёты" 
              title="" 
            />
          </div>
        </div>
...
Reports.layout = page => <LayoutFolderChlank img="medicalstatistics" h1="Отчёты" backgroundColor="bg-purple-500">{page}</LayoutFolderChlank>;
