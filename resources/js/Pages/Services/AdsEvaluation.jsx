...
export default function AdsEvaluation() {
  ...
  const priceNotes = [
    "К стоимости услуги может применяться Понижающий коэффициент.",
    "В рамках договоров государственных закупок - Понижающий коэффициент до -50% к объявленной сумме казначея.",
    "Для Образовательных услуг (п.Б) и Повышения квалификации (п.В.) - Понижающий коэффициент -50% для физических лиц."
  ];
