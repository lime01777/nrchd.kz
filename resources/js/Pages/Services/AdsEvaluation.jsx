...
export default function AdsEvaluation() {
  ...
  const priceItems = [
    { 
      ...
      priceWithoutVAT: "118 331 тенге" 
    },
  { 
    name: "Оценка рекламного видеоролика", 
    unit: "1 видеоролик", 
    priceWithVAT: "123 240 тенге", 
    priceWithoutVAT: "110 036 тенге" 
  },
  { 
    name: "Оценка печатного рекламного модуля", 
    unit: "1 модуль", 
    priceWithVAT: "143 415 тенге", 
    priceWithoutVAT: "128 049 тенге" 
  },
  { 
    name: "Оценка рекламного аудиоролика", 
    unit: "1 аудиоролик", 
    priceWithVAT: "94 896 тенге", 
    priceWithoutVAT: "84 729 тенге" 
  },
  { 
    name: "Оценка рекламного баннера (одна тексто-графическое изображение)", 
    unit: "1 модуль", 
    priceWithVAT: "123 810 тенге", 
    priceWithoutVAT: "110 545 тенге" 
  },
  { 
    name: "Оценка рекламного баннера (ряд тексто-графическое изображение)", 
    unit: "1 модуль", 
    priceWithVAT: "143 628 тенге", 
    priceWithoutVAT: "128 239 тенге" 
  }
];
  ...
  const faqItems = [
    {
      ...
      answer: (
        <div>
          ...
          <p>
            Вышеуказанные материалы заявитель направляет на электронную почту ННЦРЗ (a.skakova@nrchd.kz) и оригиналы документов предоставляет нарочно в Департамент совершенствования лекарственной политики ННЦРЗ по адресу г.Астана, ул. А.Иманова 11, Бизнес центр «Нурсаулет-1», 3 этаж, 306/3 каб., в рабочие дни с 9-00 до 17-00, перерыв на обед с 13-00 до 14-00.
          </p>
          <p className="mt-2">
    ...
    },
    {
      ...
      answer: (
        <div>
          <p>Ответы на частые вопросы вы можете найти в документе «Вопросы с сайта»</p>
          <a href="/storage/documents/Услуги/Оценка рекламных материалов/Вопросы с сайта.pdf" target="_blank" className="text-blue-600 hover:underline">
            Скачать PDF с частыми вопросами
          </a>
        </div>
      )
    },
