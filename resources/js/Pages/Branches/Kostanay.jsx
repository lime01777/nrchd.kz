...
export default function Kostanay() {
    ...
    const description = "Костанайский филиал Национального научного центра развития здравоохранения имени Салидат Каирбековой осуществляет научно-методическое сопровождение медицинских организаций Костанайской области. Филиал проводит мониторинг и анализ деятельности медицинских организаций, реализует образовательные программы и консультативно-методическую помощь медицинским организациям региона.";
