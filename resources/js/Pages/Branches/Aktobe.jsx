...
export default function Aktobe() {
    ...
    const description = "Актюбинский филиал Национального научного центра развития здравоохранения имени Салидат Каирбековой координирует работу медицинских организаций региона, внедряет инновационные методы организации медицинской помощи, проводит научно-практические исследования и образовательные мероприятия для повышения квалификации медицинских работников Актюбинской области.";
