                    ...
                    <div className="w-full">
                        ...
                        <div
                            ...
                            <div className="flex justify-center">
                                <button
                                    className="inline-flex text-white bg-purple-500 border-0 py-2 px-6 focus:outline-none hover:bg-purple-600 rounded-xl text-lg shadow-lg mt-3">Посмотреть</button>
                            </div>
                        </div>
                    </div>
