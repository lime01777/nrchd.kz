/**
 * Контактная информация для всех территориальных департаментов
 * Данные из таблицы контактов территориальных департаментов
 * Обновлено на основе предоставленной таблицы
 */

export const branchesContacts = {
    // Городские территориальные департаменты
    'Astana': {
    ...
    // Областные территориальные департаменты
    'AlmatyRegion': {
...
/**
 * Получить контактную информацию для территориального департамента
