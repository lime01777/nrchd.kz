"""
Примеры типизированных структур данных
"""
...
if __name__ == "__main__":
    # Создание типизированной сущности
    ...
    print(f"Препарат: {record.original_name}")
    print(f"Уровень доказательности: {record.system_ud}")
    print(f"Включен в BNF: {record.formulary_bnf}")
