import{R as c,j as e}from"./app-CwrL-jaW.js";import{H as d,F as f}from"./Footer-Ci9AFMzX.js";/* empty css             */function x({img:a,h1:l,useGif:s=!1,useVideo:r=!1,overlay:i=!0,videoFormat:o="mp4"}){let t="";return r?t=`/img/HeroVideos/${a}.${o}`:s?t=`/img/HeroGifs/${a}.gif`:t=`/img/HeroImg/${a}.png`,c.useEffect(()=>{if((s||r)&&!document.getElementById("hero-media-styles")){const n=document.createElement("style");n.id="hero-media-styles",n.textContent=`
          .hero-gif-background {
