import{R as n,j as e}from"./app-H5ZEkdZw.js";/* empty css             */function h({img:a,h1:i,useGif:r=!1,useVideo:l=!1,overlay:m=!0,videoFormat:o="mp4"}){let t="";return l?t=`/img/HeroVideos/${a}.${o}`:r?t=`/img/HeroGifs/${a}.gif`:t=`/img/HeroImg/${a}.png`,n.useEffect(()=>{if((r||l)&&!document.getElementById("hero-media-styles")){const s=document.createElement("style");s.id="hero-media-styles",s.textContent=`
          .hero-gif-background {
